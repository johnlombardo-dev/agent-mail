...
This JSON file is the final signed and normative issue #248 rebind of the report-creation authority. It preserves user-selected capacity Policy A and every report, normalized-text, persistence, source-serving, admission, recovery, and CLI invariant while replacing the stale live-tip-28 migration view with the exact independently signed issue #247 authority at commit 47b4866935bce94fb4a87864731870e13498910a. Accepted report creation remains slot 28; unrelated issue #246 approval-creator-provenance-repair is accepted at slot 29 and commit 8b356bb15a9de481460a0d46b54b395a08dad82a. It consumes issue #249's exact test-only live-tip proof on the already authorized #232 report-migration test path without widening production or test scope. The design, decisions, and coverage Markdown files are exact checked projections of this authority.

Implementation rule: Issue 248 changes only the five report-creation authority artifacts and does not reopen or widen issue #232 implementation scope. The accepted issue #232 report implementation remains exact slot 28 and every prior report invariant remains byte-semantically unchanged. This final authority consumes the exact signed issue #247 commit and artifact hashes plus live-tip-29 identity without treating accepted unrelated slot 29 as report authority. Separately authorized issue #249 changes only the already listed report-creation-migration test and is pinned as exact proof input. Any capacity-policy, report-slot, public-schema, protected-path, planning-ledger, or unrelated frozen-input drift requires a separate explicit authority revision.
...
Counterexamples: self-test-inventory-deletion, self-test-inventory-duplicate-id, self-test-inventory-cross-array-duplicate-id.
...
Migration: Report creation remains exactly packages/storage/src/migrations/0028-report-creation.ts at canonical slot 28 after immutable prefix 1..27 and historical target digest 39971e45e0fe51580b0343d05b935a7583e42544b2f96ba6468bd813a11b68ab. The signed normative issue #247 authority accepts unrelated issue #246 approval-creator-provenance-repair at exact slot 29 and commit 8b356bb15a9de481460a0d46b54b395a08dad82a, producing live tip 29 and registry identity 70360bc55dd45b4cc7a851b8f39eed2c77a598dd05f57aa757e3f63a88e27e57; it does not renumber, replace, or semantically alter report slot 28. The protected converter still stops at target 27, and the common opener gates both suffixes before exact-current-tip verification and safe recording. No #232 production or test scope is widened by this authority-only rebind.

Prefix evolution: Keep accepted report slot 28 exact within the sole canonical registry. The real legacy converter resolves explicit target 27, executes and ledgers only canonicalDatabaseMigrations.slice(0, 27), sets user_version 27, verifies that exact base, and returns without observing live suffixes. The common production opener then invokes strict applyMigrations over the complete registry; beforePendingMigration verifies each locked predecessor before report slot 28 and accepted unrelated issue #246 slot 29 effects. Only after exact live tip 29, identity 70360bc55dd45b4cc7a851b8f39eed2c77a598dd05f57aa757e3f63a88e27e57, canonical state, and integrity verification may the effect-safe recorder fingerprint authority. Preserve every accepted 1..28 semantic byte and immutable target-27 provenance byte. Slot 29 is accepted at commit 8b356bb15a9de481460a0d46b54b395a08dad82a, is not report authority, and cannot change report behavior. The next legal migration is 30; checker-only 30/31 suffixes confer no production authority.
...
1. the real legacy converter commits and verifies only explicit historical target 27, then returns without observing slots 28 or 29
2. the common production opener routes accepted report slot 28 and accepted unrelated issue #246 slot 29 at commit 8b356bb15a9de481460a0d46b54b395a08dad82a through strict applyMigrations and the inside-BEGIN beforePendingMigration prefix verifier
3. after the complete live registry reaches exact current tip 29 and identity 70360bc55dd45b4cc7a851b8f39eed2c77a598dd05f57aa757e3f63a88e27e57, the opener verifies canonical migration state and database integrity before recorder invocation
...
Restore: Restore only to a new or empty private root, verify the exact signed canonical registry before publication, reopen through the sole registry at exact live schema version 29 and identity 70360bc55dd45b4cc7a851b8f39eed2c77a598dd05f57aa757e3f63a88e27e57, and verify report/source/projection records, canonical string round trips, all digests, all UPDATE/DELETE/REPLACE/duplicate-key guards, recomputed Policy A count/logical charge, and restored rolling-rate state without reset or double charge. A converted database retains immutable historical target-27 provenance after gated report slot 28 and accepted unrelated slot 29; unknown targets or live-full-digest substitutions reject in preflight, pre-suffix, reopen, doctor, backup, and restore. Preserve owner/account authorization and raw EML for the safe materializer.
